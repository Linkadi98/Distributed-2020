...
public extension Date {
     ...
     */
    init?(fromString string: String, format: DateFormatType, timeZone: TimeZoneType = .local, locale: Locale = Locale.current, isLenient: Bool = true) {
    ...
    /*
     Creates a new Date based on the first date detected on a string using data detectors.
     */
...
public enum DateFormatType {
    ...
    case customDateTimeSecWithoutZone
    ...
    var stringFormat:String {
        ...
        case .customDateTimeSecWithoutZone: return "yyyy-MM-dd HH:mm:ss"
